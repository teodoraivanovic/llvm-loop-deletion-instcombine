...
for.body:                                         ; preds = %for.cond
  store i32 0, i32* %inner_sum, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = load i32, i32* %inner_sum, align 4
  %add = add nsw i32 %3, %2
  store i32 %add, i32* %inner_sum, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond1
  %5 = load i32, i32* %inner_sum, align 4
  %mul = mul nsw i32 %5, 2
